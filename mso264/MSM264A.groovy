 ...
 * 
 * */
public class MSM264A extends MSOHook {
    ...
    public GenericMsoRecord onPreSubmit(GenericMsoRecord screen) {
        ...
        if (!screen.nextAction.equals(GenericMsoRecord.F3_KEY)) {
            ...
            for (int i = 1; i < 4; i++) {
                ...
                ProjectNumber = screen.getField("WORK_ORDER1I" + i).getValue().toString().padRight(8," ");
                log.info("ProjectNumber${i}###: " + ProjectNumber)
                log.info("PwInd${i}###: " + PwInd)
                String ParenProject = ProjectNumber.substring(0, 6) + "00";
                log.info("ParenProject${i}###: " + ParenProject)
                if (PwInd.equals("P") && ProjectNumber.length() > 0 && ProjectNumber != null) {
                    ...
                    try {
                        ...
                        log.info("ProjectNumber###: " + ParenProject + " No encontrado")
                    }
                    if (msf660Rec != null) {
